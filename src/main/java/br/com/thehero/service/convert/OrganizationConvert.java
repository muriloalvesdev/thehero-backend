...
public final class OrganizationConvert {
  ...
  public static final Organization convertDataTransferObjectToEntity(OrganizationDTO dto) {
    return new Organization(dto.getName(), dto.getEmail(), String.valueOf(dto.getWhatsapp()),
        dto.getCity(), dto.getUf(), dto.getCnpj());
  }

  public static final OrganizationDTO convertEntityToDataTransferObject(Organization org) {
    return new OrganizationDTO(org.getName(), org.getEmail(), Integer.parseInt(org.getWhatsapp()),
        org.getCity(), org.getUf(), org.getCnpj());
  }
}
